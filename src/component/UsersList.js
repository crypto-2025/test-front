            ...
            <Box className={classes.idtxt}>
              <Grid container spacing={0}>
                <Grid item xs={12} md={8} className={classes.dlflex}>
                  <label style={{ padding: "0px" }}>{t('Search')}</label>
                  <Input
              ...
              <Grid container spacing={0}>
                <Grid item xs={12} md={8} className={classes.dlflex}>
                  <label style={{ padding: "0px" }}>{t(' Select user type ')}</label>
                  <Box>
                    <Select
                      fullWidth
                      ...
                      onChange={_onInputChange}
                    >
                      <MenuItem value="Creator">{t('Creator')}</MenuItem>
                      <MenuItem value="User">{t('Subscriber')}</MenuItem>
