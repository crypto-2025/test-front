...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    alignItems: "center", // لجعل المحتوى مركزيًا
  ...
  cardActions: {
    ...
    alignItems: "center",
    width: "100%", // لجعل الأزرار متوزعة عبر العرض بالكامل
  },
  subButton: {
    ...
    fontSize: "12px",
    "&:hover": {
      background: "linear-gradient(90deg, #DC39FC 30%, #6345ED 90%)",
    },
  },
    ...
    const generatePDF = async (formData, itemData) => {
      ...
      if (barcodeDataUrl) {
        ...
        doc.addImage(
          barcodeDataUrl,
          "PNG",
          pageWidth - marginRight - barcodeWidth,
          marginTop,
          barcodeWidth,
          20
        ); // Height adjusted to 20mm
      }
    ...
    return (
      <>
        ...
        >
          ...
          <DialogContent
            style={{ background: "linear-gradient(0deg, #fff, #c99bfbb0)"  , borderRadius:"20px"}}
          >
            <Typography
              variant="body1"
              style={{ color: "#6345ED", fontSize: "1.3rem" }}
            >
          ...
          <Box textAlign="center" width="100%">
            <Button onClick={onClose} color="primary" className={classes.btnOutPro}>
              {t('Cancel')}
            </Button>
            <Button
              onClick={handleBuy}
        ...
        <Dialog
          ...
          onClose={() => {}}
          aria-labelledby="successed-dialog-title"
          maxWidth="sm"
          fullWidth={true}
        >
          <DialogTitle id="successed-dialog-title">
            {t('successed Purchase')}
          </DialogTitle>
          <DialogContent>
            <Typography variant="body1">
              {" "}
              {t('your purchase successed.... You can dawnload your bill now')}.
            </Typography>
      ...
      <Card className={classes.root}>
        ...
        <CardActions disableSpacing className={classes.cardActions}>
          {auth?.userData?._id !== userId && !isBuyed && (
            <Button className={classes.subButton} onClick={handleClickOpen2}>
              {t('Details')}
            </Button>
          )}
        ...
        >
          <DialogContent   style={{overflowY: 'scroll', scrollbarWidth: 'none', }}>
            ...
            <Box mt={2} className={classes.deskiText}>
              <Typography
                ...
                align="left"
                color="#000"
                style={{ color: "#6345ED", fontWeight: "bold", marginTop: 5 }}
              >
                {t('Price')}:
                <span>
                  {itemData.donationAmount} {itemData.coinName}
            ...
            <Box mt={3} mb={3} textAlign="center">
              <Button className={classes.btnOutPro} onClick={handleClose2}>
                {t('Cancel')}
              </Button>
              &nbsp;&nbsp;
              <Button
