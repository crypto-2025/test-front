...
import { CEO_NAME, tokensDetails } from "src/constants";
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <Typography
              variant="h4"
              align="center"
              style={{ color: "#c600a4", margiBottom: "10px" }}
            >
                ...
                <Grid item xs={12}>
                  <Box mt={4}>
                    <Input
                      ...
                      placeholder={
                        "Minimum amount 1 " + selectedToken?.name?.toString()
                      }
            ...
            <DialogContent className={classes.certificate}>
              <Box className={classes.certificateBox}>
                ...
                <Box className={classes.heading}>
                  ...
                  <Typography variant="h6">وصل استلام</Typography>
