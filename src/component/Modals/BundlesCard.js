    ...
    <Box className={classes.cards}>
      ...
      >
        {user.userData && user.userData._id === data.userId && (
          <MenuItem onClick={handleClickOpen}>{t('Edit')}</MenuItem>
        )}
        <MenuItem onClick={handleClickOpen1}>{t('View')}</MenuItem>
      ...
      <Box className={classes.contantCard}>
        ...
        >
          <span style={{ color: "#707070" }}>{t('Donation Amount')}: </span>
        ...
        <Typography
          ...
          style={{ color: "#000", fontWeight: "400" }}
        >
          <span style={{ color: "#707070" }}>{t('Duration')}: </span>
          {isDays
            ? data.duration
      ...
      >
        <DialogContent>
          ...
          <Box mt={3} className={classes.bundleText} textAlign="center">
            ...
            <Typography variant="h4">{t('The basic bundle')}</Typography>
          </Box>

          <Box mt={2} className={classes.deskiText}>
            <Typography variant="h4" align="left" color="textSecondary">
              {t('Donation Amount')}: <span>{data.donationAmount} MAS</span>
            </Typography>
            <Typography variant="h4" align="left" color="textSecondary">
             {t('Duration')}: <span>{data.duration}</span>
            </Typography>
            <Grid container spacing={2}>
