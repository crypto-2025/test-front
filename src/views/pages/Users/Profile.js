    ...
    <>
      <Box>
        ...
        <Box className={classes.profilebg} mt={3}>
          {data?.coverPic && (
            <img
              src={data?.coverPic ? data?.coverPic : ""}
            ...
            <Grid container spacing={3}>
              <Grid item xl={12} md={12} align="center">
                ...
                <Typography variant="h3" >
                  ...
                  <span style={{ color: "#6345ED", borderBottom: "1px solid #6345ED", padding: "3px 10px", margin: "10px" }}>
                    {data?.name
                      ? data.name
                ...
                <Box mt={2} mb={1}>
                  {data?.ethAccount?.address && (
                    <Typography className={classes.walletAndRefferal} variant="h6" >
                      ...
                      >
                        <FiCopy onClick={() => toast.info(t("Copied"))} />
                      </CopyToClipboard>
                    </Typography>
                  )}
                </Box>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (auth?.userData?._id !== data?._id) {
                            ...
                            toast.error(t("You can not subscribe yourself"));
                          }
                        }}
                        disabled={isLoading}
                      >
                      ...
                      onClick={() => {
                        if (auth?.userData?._id) {
                          if (auth?.userData?._id !== data?._id) {
                            ...
                            toast.error(t("You can not donate yourself"));
                          }
                        } else {
                      ...
                      onClick={() => {
                        if (auth?.userData?._id) {
                          if (auth?.userData?._id !== data?._id) {
                            ...
                            toast.error(t("You can not chat yourself"));
                          }
                        } else {
                          toast.error(t("Please Login"));
                          setTimeout(() => {
