  ...
  return (
    <Box className={classes.paddingContainer}>
      <Box className={classes.LoginBox} mb={5}>
                ...
                <Box className={classes.idtxt}>
                  <Grid container spacing={0}>
                    <Grid item xs={12} md={8} className={classes.dlflex}>
                      ...
                      <Input
                        placeholder={t("Search by wallet Address or name")}
                        className={classes.input_fild2}
                        value={filterData.searchKey}
                        fullWidth
                        type="text"
        ...
        {/* Start Table */}
        <TableContainer
          style={isMobile ? { width: "400px!important" } : { width: "100%" }}
          component={Paper}
        >
            ...
            >
              <TableRow>
                <TableCell
                  ...
                  align="Center"
                  style={{ color: "white", padding: "1px", width: "10px!important" }}
                >
                  {t("Img")}
                </TableCell>
                ...
                <TableCell align="Center" style={{ color: "white", fontSize: "14px" }}>
                  {t("Wallet Address")}
                </TableCell>
                <TableCell align="Center" style={{ color: "white" }}>
                  {t("Speciality")}
        ...
        <Box mt={3}>
          {!isLoadingData && allUserList && allUserList.length === 0 && <NoDataFound />}
        </Box>
