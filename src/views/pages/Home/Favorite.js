  ...
  return (
    ...
    <Box className={classes.LoginBox}>
      <Box className={classes.favoritetitle}>
        {t('Find a new MAS. Connect to your favorite one!')}
      </Box>
