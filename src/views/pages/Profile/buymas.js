  ...
  return (
    ...
    <Box className={classes.balanceContainer}>
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
        <h2>{t('Buy Cryptocurrency')} (MAS)</h2>
      </div>
      ...
      <BalanceBox
        ...
        style={{    background: "linear-gradient(to top right, #640D5F, rgb(1, 15, 78))"}}
      />
    </Box>
      <br />
      ...
      <br />
    <div>
              <p>{t('External wallet')}: {metaMaskAddress}</p>
              <p>{t('USDT Balance in External wallet')}: {usdtBalanceInUSDT.toFixed(3)}</p>
