      ...
      <Container maxWidth="xl">
        ...
        <Box className>
          <Box mt={5}>
            <Grid container spacing={1}>
              ...
              <Grid item xs={12} md={5}>
                <label className={classes.name}> {t('Title')}:</label>
                <TextField
                  fullWidth
                  id="standard-basic"
                  placeholder=""
          ...
          <Box>
            <Grid container spacing={1}>
              <Grid item xs={12} md={5}>
                <label className={classes.name}> {t('Details')}: </label>
                <JoditEditor
          ...
          <Box>
            <Grid container spacing={1}>
              <Grid item xs={12} md={5}>
                <label className={classes.name}> {t('Upload a photo/video')}: </label>
                ...
                {isSubmit && image === "" && (
                  <FormHelperText error>{t('Please select image')}</FormHelperText>
                )}
              </Grid>
            </Grid>
            <Grid container spacing={1}>
              <Grid item xs={12} md={5}>
                <label className={classes.name}> {t('Select post type')} </label>
                <Box>
                  <Select
                    fullWidth
                    value={activities}
          ...
          <Box>
            <Grid container spacing={1}>
              <Grid item xs={12} md={12}>
                <label className={classes.name}>
                  {t('Select a bundle to share with:')}
                </label>
                <Box style={{ justifyContent: "start" }}>
                  {bundles && bundles.length === 0 && (
                    <Button
                      ...
                      size="large"
                      color="secondary"
                      style={{ minWidth: "200px",background: "linear-gradient(to bottom right, #640D5F, rgb(199, 113, 238))" }}
            ...
            <Box display="flex" justifyContent="center">
              {isSubmit && list.length === 0 && (
                <FormHelperText error>{t('Please select bundle')}</FormHelperText>
              )}
            </Box>
          </Box>
        </Box>
        ...
        <Box align="center" mt={5}>
          <Button
            ...
            disabled={loader}
          >
            {t('Share')} {loader && <ButtonCircularProgress />}
          </Button>
          <Button
            variant="contained"
            size="large"
