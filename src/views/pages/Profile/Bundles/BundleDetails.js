          ...
          <Box className={classes.headbox2}>
            <Box style={{ display: "flex", flexWrap: "wrap" }}>
              ...
              <Box className={`${classes.text1} seats`}>
                ...
                <Box mt={1}>
                  ...
                  >
                    <Typography variant="h4">{t('Donation Amount')}:</Typography>&nbsp;
                  ...
                  <Box
                    ...
                    className={classes.bundleData}
                  >
                    <Typography variant="h4">{t('Time Duration')}:</Typography>&nbsp;
                    <Typography variant="h4">
            ...
            <Box className={classes.btnhead}>
              ...
              >
                ...
                <Typography variant="h5">{t('Subscribers')}</Typography>
              </Box>
              <Button
            ...
            <Box className={classes.whitebox}>
              <Container>
                <Box className={classes.idtxt}>
                  ...
                  <Grid container spacing={0}>
                    <Grid item xs={12} md={8} className={classes.dlflex}>
                      <label> {t('Select post type')} </label>
                      <Box>
                        <Select
                          fullWidth
