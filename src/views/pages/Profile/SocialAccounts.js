  ...
  return (
    <Accordion>
      <AccordionSummary expandIcon={<ExpandMoreIcon />} style={{ background:"#c695da61" }}>
        <Typography>{t('Social Accounts')}</Typography>
      </AccordionSummary>
      <AccordionDetails>
        <Box>
          <Box mb={2}>
            <TextField
              ...
              value={facebook}
              required="false"
              placeholder={t('Please enter your facebook page url')}
              // error={!facebook}
            ...
            <TextField
              ...
              required="false"
              value={twitter}
              placeholder={t('Please enter your twitter @username')}
              // error={!twitter}
            ...
            <TextField
              ...
              required="false"
              value={telegram}
              placeholder={t("Please enter your telegram @username")}
              // error={!telegram}
            ...
            <TextField
              ...
              required="false"
              value={youtube}
              placeholder={t("Please enter your youtube channel url")}
              // error={!youtube}
