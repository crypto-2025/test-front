                    ...
                    <TableRow className={classes.tbody} key={row.coinName}>
                      ...
                      <TableCell style={{ color: "black" }} align="Center">
                        {row.transactionType === "Donation" ? 
                          (auth.userData._id === row.toDonationUser._id) ? 
                            (parseFloat(row.amount) - parseFloat(row.adminCommission)).toFixed(2) : 
                      ...
                      >
                        {(row.transactionType === "Withdraw" || 
                          ...
                          sortAddress(row.fromAddress) : "N/A"}
                      </TableCell>
                      <TableCell
                        style={
                      ...
                      <TableCell style={{ color: "black" }} align="Center">
                        {row?.transactionType ? 
                          row?.transactionType?.toUpperCase() : "N/A"}
                      </TableCell>
                      ...
                      <TableCell style={{ color: "black" }} align="Center">
                        ...
                        >
                          <FiCopy onClick={() => toast.info(t("data Copied"))} />
                        </CopyToClipboard>
                      </TableCell>
                      <TableCell style={{ color: "black" }} align="Center">
